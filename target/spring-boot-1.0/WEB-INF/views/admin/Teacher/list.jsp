...
<c:url var="teacherListURL" value="/admin/teacher-list"/>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row"
                    ...
                    <div class="col-xs-12">
                        <display:table name="teachers" cellspacing="0" cellpadding="0" requestURI="${teacherListURL}"
                                       id="tableList"
                        ...
                        >
                            ...
                            <display:column title="Thao tác">
                                <a href="/admin/teacher-edit-${tableList.id}">
                                    <button class="btn btn-xs btn-info">
                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                    </button>
                                </a>
                                <button class="btn btn-xs btn-danger" title="giáo viên"
                                        onclick="deleteTeacher(${tableList.id})">
                                    <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                </button>
                            </display:column>
                        </display:table>
                        <input type="hidden" name="Course" id="teacherId" value="">
                    </div><!-- /.span -->
                    <div class="widget-title pull-right " style="margin-right: 10px">
                        <a href="/admin/teacher-edit">
                        ...
                        <button class="btn btn-danger" title="Xóa giáo viên" id="btnDeleteTeacher">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<script>
    ...
    $('#btnDeleteTeacher').click(function (e) {
        e.preventDefault();
        var data = {};
        data['teacherId'] = $('#teacherId').val();
        var teacherIds = $('#tableList').find('tbody input[type = checkbox]:checked').map(function () {
            return $(this).val();
        }).get();
        deleteTeachers(teacherIds);
    });

    function deleteTeachers(data) {
        $.ajax({
            type: "DELETE",
            url: "${teacherAPI}/" + data,
            ...
            error: function (respond) {
                console.log("fail");
                window.location.href = "<c:url value="/admin/teacher-list?message=success"/> ";
            }
        });
    }
</script>
