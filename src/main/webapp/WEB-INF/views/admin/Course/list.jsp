                ...
                <div class="widget-box ui-sortable-handle collapsed">
                    ...
                    <div class="widget-body" style="display: block;font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;" >
                        <div class="widget-main" >
                            <form:form id="listForm" modelAttribute="modelSearchRequest" action="${courseListURL}" method="GET">
                                <!-- danh sach tim kiem -->
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <div class="col-sm-6">
                                                <button class="btn btn-danger" type="button" id="btnSearchCourse">Tìm kiếm</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="widget-title pull-right">
                        ...
                        <button class="btn btn-danger" title="Xóa sach" id="btnDeleteCourse">
                    ...
                    <div class="col-xs-12">
                        <display:table name="courses" cellspacing="0" cellpadding="0" requestURI="${courseListURL}"
                            ...
                            <display:column title="Thao tác">
                                    <button class="btn btn-xs btn-success" title="Giao khóa học cho giáo viên" onclick="assignmentCourse(${tableList.id})">
                                ...
                                <a href="/admin/course-edit-${tableList.id}" >
                                    ...
                                    <button class="btn btn-xs btn-danger" title="Xóa khóa học" onclick="deleteCourse(${tableList.id})">
