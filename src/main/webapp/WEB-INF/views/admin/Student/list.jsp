        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row"
                    ...
                    <div class="col-xs-12">
                        <display:table name="students" cellspacing="0" cellpadding="0" requestURI="${studentListURL}"
                                       id="tableList"
                        ...
                        >
                            ...
                            <display:column title="Thao tác">
                                ...
                                <button class="btn btn-xs btn-danger" title="học viên"
                    ...
                    <div class="widget-title pull-right " style="margin-right: 10px">
                        ...
                        <button class="btn btn-danger" title="Xóa học viên" id="btnDeleteStudent">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    function deleteStudents(data) {
        $.ajax({
            ...
            error: function (respond) {
                console.log("fail");
                window.location.href = "<c:url value="/admin/student-list?message=success"/> ";
            }
        });
    }
</script>
