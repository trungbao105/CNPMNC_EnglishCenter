...
<div id="sidebar" class="sidebar                  responsive                    ace-save-state" style="color: #FFFFFF">
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text">Quản lý lịch học</span>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
                <li class="">
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text">  Đăng ký khóa học  </span>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
                <li class="">
